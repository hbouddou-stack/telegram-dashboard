...
async def send_single_onboarding_email(email, first_name, student_id, gender):
    ...
    try:
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #f0f4f3; margin: 0; padding: 25px 12px; color: #17262c; direction: rtl; text-align: right;">
            <div style="max-width: 580px; margin: 0 auto; background: #ffffff; border-radius: 24px; padding: 32px 26px; border-top: 6px solid #079176; box-shadow: 0 10px 35px rgba(12,74,60,0.08);">
                
                <!-- HEADER WITH OFFICIAL LOGO -->
                <div style="text-align: center; margin-bottom: 18px;">
                    <img src="cid:albaji_logo" alt="شعار أكاديمية الباجي" width="125" style="max-width: 125px; height: auto; margin-bottom: 8px; display: inline-block; border: 0;">
                    <div>
                        <span style="background: rgba(7, 145, 118, 0.12); color: #0c4a3c; font-weight: 800; font-size: 13px; padding: 4px 16px; border-radius: 20px;">● رسالة التفعيل والانضمام الرسمية</span>
                    </div>
                </div>

                <!-- WELCOME GREETING & RESTORED FULL TEXT -->
                <div style="background: #fafafa; border: 1px solid #e2e8f0; border-radius: 16px; padding: 20px 22px; margin-bottom: 22px; line-height: 1.8; font-size: 15px; color: #2d3748;">
                    <h2 style="color: #0c4a3c; margin: 0 0 10px 0; font-size: 19px; font-weight: 900;">{greeting}</h2>
                ...
                <!-- BOUTON D'ACTION AVEC ÉMOJI MAIN EN BAS -->
                <div style="text-align: center; margin: 22px 0; background: linear-gradient(180deg, #edf7f4 0%, #e1f2ec 100%); padding: 22px 18px; border-radius: 18px; border: 1px dashed #079176;">
                    <p style="margin: 0 0 12px 0; font-weight: 800; color: #0c4a3c; font-size: 15px;">👇 اضغط هنا للانضمام إلى المجموعة الرسمية:</p>
                    <a href="{direct_tg_link}" style="background: linear-gradient(135deg, #079176 0%, #0c4a3c 100%); color: #ffffff !important; text-decoration: none; padding: 18px 36px; border-radius: 35px; font-weight: 900; font-size: 17px; display: inline-block; box-shadow: 0 8px 25px rgba(7, 145, 118, 0.35);">
                        تفعيل الحساب وإضافة المجلد (تيليجرام)
                    </a>
                </div>
                
                <!-- DETAILS CARD -->
                <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 14px; padding: 18px 20px; margin: 22px 0;">
